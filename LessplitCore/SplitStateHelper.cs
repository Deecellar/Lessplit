...
{
    public static class SplitStateHelper
    {
        public static TimeSpan? GetLastDelta(SplitterState state, int splitNumber, string comparison, TimingMethod method)
        {
        ...
        private static TimeSpan? GetSegmentTimeOrSegmentDelta(SplitterState state, int splitNumber, bool useCurrentTime, bool segmentTime, string comparison, TimingMethod method)
        {
        ...
        public static TimeSpan? GetPreviousSegmentTime(SplitterState state, int splitNumber, TimingMethod method)
        {
            return GetSegmentTimeOrSegmentDelta(state, splitNumber, false, true, Run.Run.PersonalBestComparisonName, method);
        }
        ...
        public static TimeSpan? GetLiveSegmentTime(SplitterState state, int splitNumber, TimingMethod method)
        {
            return GetSegmentTimeOrSegmentDelta(state, splitNumber, true, true, Run.Run.PersonalBestComparisonName, method);
        }
        ...
        public static TimeSpan? GetPreviousSegmentDelta(SplitterState state, int splitNumber, string comparison, TimingMethod method)
        {
        ...
        public static TimeSpan? GetLiveSegmentDelta(SplitterState state, int splitNumber, string comparison, TimingMethod method)
        {
        ...
        public static TimeSpan? CheckLiveDelta(SplitterState state, bool splitDelta, string comparison, TimingMethod method)
        {
            if (state.CurrentPhase == TimerState.Running || state.CurrentPhase == TimerState.Paused)
            {
        ...
        public static Color? GetSplitColor(SplitterState state, TimeSpan? timeDifference, int splitNumber, bool showSegmentDeltas, bool showBestSegments, string comparison, TimingMethod method)
        {
