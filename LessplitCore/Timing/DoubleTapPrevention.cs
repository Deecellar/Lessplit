...
{
    public class DoubleTapPrevention : ITimer
    {
        ...
        public ITimer InternalModel { get; set; }
        ...
        public event EventHandler<TimerState> OnReset { add { InternalModel.OnReset += value; } remove { InternalModel.OnReset -= value; } }
